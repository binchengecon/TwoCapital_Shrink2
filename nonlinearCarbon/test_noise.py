...
def model(time, pulse, sigma_T, sigma_C, id):
...
for max in maxarray:
    ...
    plt.tight_layout()
    plt.savefig(Figure_Dir+"Pulse="+file_name+"_pulsetime=" +
                str(year)+",pulsesize="+str(max)+".pdf")
    plt.savefig(Figure_Dir+"Pulse="+file_name+"_pulsetime=" +
                str(year)+",pulsesize="+str(max)+".png")
