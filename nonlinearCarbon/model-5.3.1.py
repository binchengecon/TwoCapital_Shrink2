...
Can = pd.read_csv("./nonlinearCarbon/data/rcp30co2eqv3.csv")
...
plt.tight_layout()
plt.savefig(Figure_Dir+f"Pulse=rcp30co2eqv3_Erik.pdf")
plt.savefig(Figure_Dir+f"Pulse=rcp30co2eqv3_Erik.png")
