...
model_dir_pre2=Data_Dir+ File_Name + "model_tech2_pre_damage"+"_LR_{}".format(fractionarr[0])
if os.path.exists(model_dir_pre2):
    model_tech1_post_damage = pickle.load(open(model_dir_pre2, "rb"))
else:
    ...
    with open(model_dir_pre2, "wb") as f:
        pickle.dump(model_tech2_pre_damage, f)

    model_tech2_pre_damage = pickle.load(open(model_dir_pre2, "rb"))
######################################
##########End of Compute##############
######################################
...
with open(Data_Dir+ File_Name + "model_tech1_pre_damage"+"_LR_{}".format(fractionarr[1]), "wb") as f:
